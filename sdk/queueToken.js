...
},{"./QueueITHelpers":2,"./Token":3,"./helpers/Aes":5,"./helpers/Base64":6,"./model/PayloadDto":11}],2:[function(require,module,exports){
"use strict";
...
},{"./helpers/Aes":5,"./helpers/Base64":6,"./helpers/Md5":7,"./helpers/Sha":8}],3:[function(require,module,exports){
"use strict";
...
},{"./Payload":1,"./QueueITHelpers":2,"./helpers/Base64":6,"./model/EncryptionType":9,"./model/HeaderDto":10,"./model/TokenVersion":12}],4:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.Token = exports.Payload = void 0;
var Payload_1 = require("./Payload");
Object.defineProperty(exports, "Payload", { enumerable: true, get: function () { return Payload_1.Payload; } });
var Token_1 = require("./Token");
Object.defineProperty(exports, "Token", { enumerable: true, get: function () { return Token_1.Token; } });

},{"./Payload":1,"./Token":3}],5:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.pkcs7strip = exports.pkcs7pad = exports.ModeOfOperationCBC = exports.Aes = exports.Utf8Converter = void 0;
...
var Utf8Converter = /** @class */ (function () {
    ...
    Utf8Converter.toBytes = function (text) {
        var result = [], i = 0;
        text = encodeURI(text);
        while (i < text.length) {
    ...
    Utf8Converter.fromBytes = function (bytes) {
        var result = [], i = 0;
...
exports.Utf8Converter = Utf8Converter;
...
var Aes = /** @class */ (function () {
    ...
    Aes.prototype.prepare = function () {
        ...
        while (t < roundKeyCount) {
            ...
            if (KC != 8) {
                for (var i_1 = 1; i_1 < KC; i_1++) {
                    tk[i_1] ^= tk[i_1 - 1];
                }
                // key expansion for 256-bit keys is "slightly different" (fips-197)
            }
            else {
                for (var i_2 = 1; i_2 < (KC / 2); i_2++) {
                    tk[i_2] ^= tk[i_2 - 1];
                }
                tt = tk[(KC / 2) - 1];
                tk[KC / 2] ^= (S[tt & 0xFF] ^
                    ...
                    (S[(tt >> 16) & 0xFF] << 16) ^
                    (S[(tt >> 24) & 0xFF] << 24));
                for (var i_3 = (KC / 2) + 1; i_3 < KC; i_3++) {
                    tk[i_3] ^= tk[i_3 - 1];
                }
            }
            // copy values into round key arrays
            var i = 0, r = void 0, c = void 0;
 ...
 */
var ModeOfOperationCBC = /** @class */ (function () {
    function ModeOfOperationCBC(key, iv) {
        ...
        if (!iv) {
            ...
            throw new Error('invalid initialation vector size (must be 16 bytes). Actual size is: ' + iv.length.toString());
        }
    ...
    return ModeOfOperationCBC;
}());
exports.ModeOfOperationCBC = ModeOfOperationCBC;
///////////////////////
// Padding
...
},{"../QueueITHelpers":2}],7:[function(require,module,exports){
"use strict";
...
function md5(input) {
    ...
    function rh(n) {
        var j, s = new Uint8Array(4);
        for (j = 0; j <= 3; j++) {
            s[j] = parseInt(hc.charAt((n >> (j * 8 + 4)) & 0x0F) + hc.charAt((n >> (j * 8)) & 0x0F), 16);
        }
        return s;
    }
    function ad(x, y) {
    ...
    var rha = rh(a), rhb = rh(b), rhc = rh(c), rhd = rh(d);
    for (var i_1 = 0; i_1 < 4; i_1++)
        result[i_1] = rha[i_1];
    for (var i_2 = 0; i_2 < 4; i_2++)
        result[4 + i_2] = rhb[i_2];
    for (var i_3 = 0; i_3 < 4; i_3++)
        result[8 + i_3] = rhc[i_3];
    for (var i_4 = 0; i_4 < 4; i_4++)
        result[12 + i_4] = rhd[i_4];
    return result;
}
exports.md5 = md5;
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.pbkdf2 = exports.hkdf = exports.hmac = exports.sha256 = exports.HMAC = exports.Hash = exports.blockSize = exports.digestLength = void 0;
...
(function (EncryptionType) {
    EncryptionType[EncryptionType["AES256"] = 0] = "AES256";
...
},{"../QueueITHelpers":2,"../helpers/Base64":6}],11:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"../QueueITHelpers":2,"../helpers/Base64":6}],12:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.TokenVersion = void 0;
var TokenVersion;
(function (TokenVersion) {
    TokenVersion[TokenVersion["QT1"] = 0] = "QT1";
